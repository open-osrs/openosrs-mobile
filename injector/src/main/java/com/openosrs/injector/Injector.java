...
import com.openosrs.injector.injectors.FixClientInstance;
...
public class Injector extends InjectData implements InjectTaskHandler
{
	...
	public static void main(String[] args)
	{
		...
		injector.deobfuscated = load(
			new File("../deobfuscator/lib/mobile-194-mapped.jar"));
		...
		injector.mixins = load(
			new File("../runelite-mixins/build/libs/runelite-mixins.jar"));
	...
	public void injectVanilla()
	{
		...
		inject(new FixClientInstance(this));
